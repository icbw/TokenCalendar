    ...
    <div className="breakdown">
      <div className="breakdown-header">
        ...
        <div className="toolbar-group breakdown-kind">
          <button className={`seg${viewKind === 'line' ? ' is-active' : ''}`} onClick={() => setViewKind('line')}>Lines</button>
          <button className={`seg${viewKind === 'stack' ? ' is-active' : ''}`} onClick={() => setViewKind('stack')}>Stack</button>
        </div>
        <button className="breakdown-close" onClick={onClose} aria-label="Close breakdown">×</button>
      </div>
