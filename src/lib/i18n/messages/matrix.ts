...
export default {
  ...
  metricUncached: ['Input', '输入'],
  metricInput: ['Input', '输入'],
  metricCacheW: ['Cache W', '缓存写'],
  metricCacheR: ['Cache read', '缓存读取'],
  metricOutput: ['Output', '输出'],
  metricTokensHint: ['Total tokens = input + cache read + output', 'Token 总量 = 输入 + 缓存读取 + 输出'],
  metricUncachedHint: ['Input not served from cache', '未命中缓存的输入'],
  metricInputHint: ['Input not served from cache', '未命中缓存的输入'],
  metricCacheWHint: ['Cache write: input tokens written to the prompt cache', '缓存写入：写入提示缓存的输入 Token'],
  metricCacheRHint: ['Input read from cache', '从缓存读取的输入'],
  metricOutputHint: ['Output tokens', '输出 Token'],
  unitTokens: ['tokens', 'Token'],
  unitUncached: ['input tokens', '输入 Token'],
